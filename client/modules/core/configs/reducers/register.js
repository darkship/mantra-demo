...
const RegisterReducer=(state=defaultState,action)=>
{
	switch(action.type)
	{
		...
		case 'SET_PASSWORD_VERIFICATION':	
			return {...state,passwordverification:action.passwordverification,verificationisko:false};
		case 'SET_PASSWORD_VERIFICATION_ERROR':		
			return {...state,passwordverification:action.passwordverification,verificationisko:true};
		case 'REGISTER':	
